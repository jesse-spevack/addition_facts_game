...
class Game extends Component {
  ...
  scoreProblem() {
    ...
    if(problem) {
      if(correct) {
        ...
        const timeToRetireProblem = isProblemCorrectCountSignificant || (isProblemStreakSignificant && isProblemFastCountSignificant)
  ...
  render () {
    ...
    return (
      <div className="">
        <Header signOut={this.props.signOut} user={this.props.user} showStats={this.props.showStats}/>
